...
outfile = r'train/gvtest_{}.tif'

# Collect shape geometries from shapefile
sf = fiona.open("/Users/dharp/Data/GrandView/Grandview_fields/Grandview_fields_DW.shp", "r")

# Open raster image file
#rf = rasterio.open("/Users/dharp/Desktop/gv_1500dpi.tif")
rf = rio.open("/Users/dharp/Data/GrandView/Grandview_1500dpi.tif")
