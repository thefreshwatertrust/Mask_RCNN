...
class FieldDataset(utils.Dataset):
    ...
    def load_fields(self, dataset_dir, subset):
        ...
        sf = fiona.open(os.path.join(dataset_dir,"graind_view_2019_training2/graind_view_2019_training2.shp"), "r")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for i, p in enumerate(info["polygons"]):
            ...
            rf.close()
            class_ids.append(self.class_names.index(p['properties']['Irrigation']))
